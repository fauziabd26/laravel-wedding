...
Route::resource('/admin/wedding', WeddingController::class)->only(['index', 'update']);
Route::resource('/admin/bride', BrideController::class)->only(['index', 'update']);
Route::resource('/admin/events', EventController::class)->only(['index', 'update']);
