...
<body id="top" class="ss-preload theme-slides">
    ...
    <section id="details" class="s-details">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-event" class='tab-content__item'>
                        ...
                        <div class="row tab-content__item-header">
                            <div class="column">
                                <h2 class="name-bride">Save the date</h2>
                            </div>
                        </div>
                    ...
                    <!-- 03 - tab story -->
                    <div id="tab-story" class="tab-content__item">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="mb-4 text-center name-bride" data-aos="fade-up">Cerita Cinta</h1>
                                <div class="timeline-root">
                                    <div class="timeline timeline-v">
                                        <ul id="story">
        ...
        <audio controls hidden autoplay loop>
